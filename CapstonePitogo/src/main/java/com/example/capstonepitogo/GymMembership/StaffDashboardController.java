...
public class StaffDashboardController {
    ...
    @FXML
    private void openPlans(ActionEvent event) {
        loadScene("plans-view.fxml", event);
    }

    @FXML
    private void openAttendance(ActionEvent event) {
        loadScene("attendance-view.fxml", event);
    }
    ...
    private void openPayments(ActionEvent event) {
        try {
            ...
            stage.setScene(new Scene(FXMLLoader.load(getClass().getResource("payments-view.fxml"))));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
